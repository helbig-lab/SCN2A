...
system(paste0("cp ../../../scripts/pat_100k_draw_npat_cube.R ."))
...
sim_score = read_csv(paste0("cube_sim_scn2a.csv")) %>% select(-X1) 
...
rname = paste("cube_100k_",n,".R",sep = "")      
p100kR = paste0("source('pat_100k_draw_npat_cube.R');",ndraw)      
      write(p100kR,rname)
...
write.csv(gene_count,paste0("gene_count_cube_scn2a.csv"),row.names = F)
