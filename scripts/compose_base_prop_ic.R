...
system(paste0("mkdir -p ",input.yaml$output_dir))
...
write_csv(tot_base, paste0(input.yaml$output_dir,"full_base.csv"))
...
write_csv(neg_base, paste0(input.yaml$output_dir,"neg_base.csv"))
write_csv(pos_base, paste0(input.yaml$output_dir,"pos_base.csv"))
...
write_csv(neg_prop, paste0(input.yaml$output_dir,"neg_prop.csv"))
write_csv(pos_prop, paste0(input.yaml$output_dir,"pos_prop.csv"))


full_prop <- neg_prop %>% rbind(pos_prop)

write_csv(full_prop, paste0(input.yaml$output_dir,"full_prop.csv"))
...
write_csv(neg_prop_filt, paste0(input.yaml$output_dir,"neg_prop_pruned.csv"))
...
write_csv(pos_IC,paste0(input.yaml$output_dir,"pos_IC.csv"))
